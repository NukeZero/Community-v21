...
function AddGeneralAttribute( nNum, nProb, nDamageRate, nDefenseRate, nAddAtkDmgRate )
	tGeneralAttribute[nNum] = {}
	tGeneralAttribute[nNum].nProb = nProb
	tGeneralAttribute[nNum].nDamageRate = nDamageRate
	tGeneralAttribute[nNum].nDefenseRate = nDefenseRate
	tGeneralAttribute[nNum].nAddAtkDmgRate = nAddAtkDmgRate
end
