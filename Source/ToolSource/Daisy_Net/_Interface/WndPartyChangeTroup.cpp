...
//				g_DPlay.SendChangePartyName( m_sParty );
				Destroy();			
			}
#endif
...
BOOL CWndPartyChangeName::LoadInvalidName( void )
{
	CScanner s;
	TCHAR szName[64];
...
BOOL CWndPartyChangeName::IsInvalidName( LPCSTR sName )
{
	TCHAR pszName[ 64 ];
