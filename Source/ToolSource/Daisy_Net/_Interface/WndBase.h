...
//{{AFX
	CWndBase* GetChildFrameFocus( CWndBase* pWndBase, POINT point );
//}}AFX
#endif 
//protected:
public:
#ifdef __DAISY
	static BOOL m_nLayout;
	static int m_nGridWidth;
	static int m_nGridHeight;	
#endif
...
static void FreeTileTexture();
	...
	void SetDefaultImg(CString strDefaultImg){ m_strDefaultImg = strDefaultImg;}
...
virtual void AlighWindow( CRect rcOld, CRect rcNew );
	...
	virtual DWORD GetFontColor( void )	{	return m_dwColor;	}
	virtual DWORD GetFontColorR( void )	{	return m_nFontColorR;	}
	virtual DWORD GetFontColorG( void )	{	return m_nFontColorG;	}
	virtual DWORD GetFontColorB( void )	{	return m_nFontColorB;	}
