...
public:
	...
	CItemBase* GetItem( DWORD dwIndex );
...
// Operations
	...
	void	RanderIcon( C2DRender* p2DRender, CItemBase* pItemBase, int x, int y, int nParent, int nalpha = 255 );
	int		InsertItem(UINT nMask, int nItem, LPCTSTR lpszItem, UINT nState,
						UINT nStateMask, int nImage, LPARAM lParam);
#ifdef __Y0402
	CItemBase* GetItemFromArr( DWORD dwIndex );
#endif
...
protected:
	...
	int				m_nOnSelect;
#ifdef __Y0402
	CItemBase*		m_pArrayItemBase[100];
	int				m_nArrayCount;
#endif	
