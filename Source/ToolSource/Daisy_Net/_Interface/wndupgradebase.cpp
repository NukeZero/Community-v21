...
//			}
		...
		if( PtInRect(&m_Rect[1], point) )
		{
			...
			if( pItemElem->GetProp()->dwItemKind3 == IK3_ELECARD )
			{
				...
				{
					fSucessPersent[0][0] = fSucessPersent[0][1] = fSucessPersent[0][2] = 100.0f;
					fSucessPersent[1][0] = fSucessPersent[1][1] = fSucessPersent[1][2] = 0.0f;
					fSucessPersent[2][0] = fSucessPersent[2][1] = fSucessPersent[2][2] = 0.0f;
					fSucessPersent[3][0] = fSucessPersent[3][1] = fSucessPersent[3][2] = 0.0f;
					fSucessPersent[4][0] = fSucessPersent[4][1] = fSucessPersent[4][2] = 0.0f;
					
					fSucessPersent[0][3] = fSucessPersent[0][4] = 0.0f;
					fSucessPersent[1][3] = fSucessPersent[1][4] = 44.0f;
					fSucessPersent[2][3] = fSucessPersent[2][4] = 0.0f;
					fSucessPersent[3][3] = fSucessPersent[3][4] = 0.0f;
					fSucessPersent[4][3] = fSucessPersent[4][4] = 0.0f;
					
					fSucessPersent[0][5] = fSucessPersent[0][6] = 0.0f;
					fSucessPersent[1][5] = fSucessPersent[1][6] = 0.0f;
					fSucessPersent[2][5] = fSucessPersent[2][6] = 44.0f;
					fSucessPersent[3][5] = fSucessPersent[3][6] = 0.0f;
					fSucessPersent[4][5] = fSucessPersent[4][6] = 0.0f;
					
					fSucessPersent[0][7] = fSucessPersent[0][8] = 0.0f;
					fSucessPersent[1][7] = fSucessPersent[1][8] = 0.0f;
					fSucessPersent[2][7] = fSucessPersent[2][8] = 0.0f;
					fSucessPersent[3][7] = fSucessPersent[3][8] = 44.0f;
					fSucessPersent[4][7] = fSucessPersent[4][8] = 0.0f;
					
					fSucessPersent[0][9] = 0.0f;
					fSucessPersent[1][9] = 0.0f;
					fSucessPersent[2][9] = 0.0f;
					fSucessPersent[3][9] = 0.0f;
					fSucessPersent[4][9] = 44.0f;
				}			
				*/
			}
			...
			if( pItemElem->GetProp()->dwItemKind3 == IK3_DICE )
			{
				...
				if( prj.m_nLanguage == LANG_CHI || prj.m_nLanguage == LANG_TWN )
				{
					...
					fSucessPersent[0][5] = fSucessPersent[0][6] = 0.0f;
					fSucessPersent[1][5] = fSucessPersent[1][6] = 0.0f;
					fSucessPersent[2][5] = fSucessPersent[2][6] = 33.0f;
					fSucessPersent[3][5] = fSucessPersent[3][6] = 0.0f;
					fSucessPersent[4][5] = fSucessPersent[4][6] = 0.0f;
					...
					fSucessPersent[1][7] = fSucessPersent[1][8] = 0.0f;
					fSucessPersent[2][7] = fSucessPersent[2][8] = 0.0f;
					fSucessPersent[3][7] = fSucessPersent[3][8] = 22.0f;
					fSucessPersent[4][7] = fSucessPersent[4][8] = 0.0f;
		...
		case WIDC_OK:
			{
				...
				if( dwCount[0] < m_nMaxCount || dwCount[1] < m_nMaxCount )
				{
					g_WndMng.OpenMessageBox( prj.GetText(TID_UPGRADE_ERROR_NOSUPSTON), MB_OK, this );
					return FALSE;
				}
