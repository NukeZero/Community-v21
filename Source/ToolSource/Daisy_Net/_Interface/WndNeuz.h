...
//	virtual CItem* GetFocusItem() { return NULL; }
	...
	void ViweCloseButton(BOOL bButtonView);
};
...
protected:
	...
	//void PaintTexture( LPWORD pDest, LPIMAGE pImage, CPoint pt, CSize sizeSurface );//, int nImgBit )
...
public:
	...
	CWndBase* DestroyControl( LPWNDCTRL lpWndCtrl );
...
#define BEGIN_WNDCLASS( class_name ) \
		class class_name : public CWndNeuz { public: class_name(); ~class_name(); \
