...
class CDlgGuideSetting : public CDialog
{
// Construction
public:
	CDlgGuideSetting(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlgGuideSetting)
