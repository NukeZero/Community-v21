...
//Skin and physique related definitions
#define ID_SKIN_DATA			_T("*SKIN_DATA")
#define ID_SKIN_VERTICES		_T("*SKIN_VERTEX_DATA")
#define ID_SKIN_VERTEX_NUM		_T("*VERTEX")
#define ID_SKIN_BONE_NAME		_T("*BONE")
#define ID_SKIN_WEIGHT			_T("*WEIGHT")
#define ID_SKIN_OFFSET			_T("*OFFSET")
#define ID_SKIN_BONE_LIST		_T("*BONE_LIST")
