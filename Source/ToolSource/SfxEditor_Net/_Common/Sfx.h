...
extern void QuaternionRotationToYPW( const D3DXQUATERNION qRot, D3DXVECTOR3& vYPW );


// CSfx : 게임상 실제 오브젝트 클래스
...
//	DWORD	m_dwSkillLevel;	// 스킬레벨.
	...
	void Process( FLOAT fElapsedTime ); // 각 프레임마다 위치이동, 애니메이션 등 처리
