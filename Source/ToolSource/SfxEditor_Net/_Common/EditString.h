...
public:
	...
	void ParsingString( LPCTSTR lpsz, DWORD dwColor, DWORD dwStyle, CString& string, CDWordArray& adwColor, CByteArray& abyStyle );
	...
	int Insert( int nIndex, TCHAR ch, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000  );
	int Insert( int nIndex, LPCTSTR pstr, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000  );
	int Delete( int nIndex, int nCount = 1 );
	int DeleteLine( int nBeginLine, int nCount  = 1 );
	TCHAR GetAt( int nIndex ) const;
	void SetAt( int nIndex, TCHAR ch, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000 );
	void AddParsingString( LPCTSTR lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000 );
	void SetParsingString( LPCTSTR lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000 );
	void AddString( LPCTSTR lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000 );
	void AddString( char ch, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000 );
	void SetString( LPCTSTR lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000 );
	void SetString( char* lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000 );
...
public:
	...
	void Adjust( int nWidth, SIZE sizeFont );
	void Adjust( CD3DFont* pFont, CRect* pRect );
	void ParsingString( LPCTSTR lpsz, DWORD dwColor, DWORD dwStyle, WORD wCodePage, CString& string, CDWordArray& adwColor, CByteArray& abyStyle, CWordArray& awCodePage );
	void SetAlpha( DWORD dwColor );
	void SetColor( DWORD dwColor );
	void SetStyle( DWORD dwStyle );
	...
	void AddParsingString( LPCTSTR lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000, WORD wCodePage = 0 );
	void SetParsingString( LPCTSTR lpsz, DWORD dwColor = 0xff000000, DWORD dwStyle = 0x00000000, WORD wCodePage = 0 );
