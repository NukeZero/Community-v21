...
void CButtonST::PreSubclassWindow() 
{
	...
	FLASSERT(m_nTypeStyle != BS_OWNERDRAW);
...
//			Failed loading the specified resource.h
//
...
// Parameters:
//		[IN]	nCursorId
//				ID number of the cursor resource.h
...
DWORD CButtonST::SetURL(LPCTSTR lpszURL)
{
	...
	{
		// Store the URL
		FLStrncpy(m_szURL, _countof( m_szURL ), lpszURL, _MAX_PATH);
	} // if
...
// Parameters:
//		[IN]	nMenu
//				ID number of the menu resource.h
