...
//#endif
...
#ifdef __SFXEDITOR
	virtual void RenderOutLine(D3DXVECTOR3 vPos,WORD nFrame,FLOAT fAngle, D3DXVECTOR3 vScale = D3DXVECTOR3( 1.0f, 1.0f, 1.0f ) ); // 에디터용 외곽선 렌더
#endif
	...
	virtual void Save(CFileIO& file); // 세이브
...
#endif
#ifdef __SFXEDITOR
	virtual void RenderOutLine( D3DXVECTOR3 vPos, WORD nFrame, FLOAT fAngle, D3DXVECTOR3 vScale = D3DXVECTOR3( 1.0f, 1.0f, 1.0f )  );
#endif
	virtual void Save(CFileIO& file);
...
#ifdef __SFXEDITOR
	void Render( D3DXVECTOR3 vPos, WORD nFrame, FLOAT fAngle, D3DXVECTOR3 vScale = D3DXVECTOR3( 1.0f, 1.0f, 1.0f )  ); // 에디터에서만 사용
	void RenderOutLine(D3DXVECTOR3 vPos,WORD nFrame,FLOAT fAngle,BYTE nPart, D3DXVECTOR3 vScale = D3DXVECTOR3( 1.0f, 1.0f, 1.0f ) ); // 지정된 파트의 외곽선 출력. 에디터에서만 사용.
#endif
...
public:
	...
	void SetSfx(CString strSfxName);
...
public:
	...
	void NewObj(CString strSfxName,D3DXVECTOR3 vPos=D3DXVECTOR3(0,0,0),D3DXVECTOR3 vRotate=D3DXVECTOR3(0,0,0)); // 
	void Process(void);
#ifndef __WORLDSERVER
	void Render(void);
#endif
