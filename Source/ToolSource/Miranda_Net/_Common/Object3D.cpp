...
int		CObject3D :: LoadObject( LPCTSTR szFileName )
{
	...
	//sun!!
	strcpy( szName, szFileName ); //GetFileName(szFileName) );
...
//		m_pd3dDevice->SetTextureStageState( 1, D3DTSS_ALPHAARG1, D3DTA_TEXTURE );
		...
		kUV += D3DXVECTOR3( 0.0004f, 0.0004f, .0f );

	//	if( kUV.x > 1.0f )
	//		kUV = D3DXVECTOR3( 0.0f, 0.0f, 0.0f );
		m_pd3dDevice->SetVertexShaderConstantF( 91, (float*)&kUV, 1 );		//texture uv ( skinning2.vsh )

		static D3DXVECTOR3 kUV2( 0.0f, 0.0f, 0.0f );
		static const D3DXVECTOR3 kPositive( 0.002f, 0.002f, 0.002f );
		static const D3DXVECTOR3 kNegative( -0.002f, -0.002f, -0.002f );
