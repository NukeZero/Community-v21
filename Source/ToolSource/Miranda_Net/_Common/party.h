...
#ifdef __JAP_REGULATE_S0906
	#define	MAX_PTMEMBER_SIZE	8
#else // __JAP_REGULATE_S0906
	#define	MAX_PTMEMBER_SIZE	6
#endif // __JAP_REGULATE_S0906
//#define	MAX_PTMEMBER_SIZE	8

#define PARTY_MAP_SEC	3
#define PARTY_MAP_LENGTH	60
#define PARTY_MAP_AROUND	60
...
//	}
	...
	void	Lock( unsigned int uiLine/*=0*/, const char* rostrFileName/*=""*/ )	{	m_AddRemoveLock.Enter( uiLine, rostrFileName );	}
	void	Unlock( unsigned int uiLine/*=0*/, const char* rostrFileName/*=""*/ )	{	m_AddRemoveLock.Leave( uiLine, rostrFileName );	}
...
//typedef CMyMap<CParty*>	CMapParty;
//typedef CMyBucket<CParty*> CPartyBucket;
