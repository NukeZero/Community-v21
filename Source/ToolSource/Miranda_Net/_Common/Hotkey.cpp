...
void CHotkey::SetDefaultHotkey( int nMax )
{
	...
	for( int i = 0; i < nMax; i++ )
	{
...
#else // __Y0420
		case FUNC_USE1       : lpHotkey->m_nHotkey = '1'; break;
		case FUNC_USE2       : lpHotkey->m_nHotkey = '2'; break;
		case FUNC_USE3       : lpHotkey->m_nHotkey = '3'; break;
		case FUNC_USE4       : lpHotkey->m_nHotkey = '4'; break;
		case FUNC_USE5       : lpHotkey->m_nHotkey = '5'; break;
		case FUNC_USE6       : lpHotkey->m_nHotkey = '6'; break;
		case FUNC_USE7       : lpHotkey->m_nHotkey = '7'; break;
		...
		case FUNC_OLDKNOW    : lpHotkey->m_nHotkey = VK_BACK  ; break;
		case FUNC_EXIT       : lpHotkey->m_nHotkey = VK_ESCAPE; break;
		case FUNC_SCREENCAP  : lpHotkey->m_nHotkey = VK_F11   ; break;
		case FUNC_SLOT1      : lpHotkey->m_nHotkey = VK_F1    ; break;
		case FUNC_SLOT2      : lpHotkey->m_nHotkey = VK_F2    ; break;
		case FUNC_SLOT3      : lpHotkey->m_nHotkey = VK_F3    ; break;
		case FUNC_HELP       : lpHotkey->m_nHotkey = VK_F4    ; break;
		case FUNC_VIEWPARTY  : lpHotkey->m_nHotkey = VK_TAB   ; break;
		default              : lpHotkey->m_nHotkey = 0        ; break;
#endif // __Y0420
		}
