...
/*
#define	PARTS_NECKLACE1         12 // 목걸이
#define	PARTS_RING1             13 // 반지
#define	PARTS_RING2             14
#define	PARTS_EARRING1          15 // 귀걸이
#define	PARTS_EARRING2          16
#define	PARTS_PROPERTY          17 목걸이, 반지, 귀걸이를 제외한 소도구들을 착용할 공간
*/
...
#define MAX_MOVER_MENU		33 // MMI를 추가시킬 일이 있다면 이 수치를 상승시켜야 한다.
...
/*
// 액션 시퀀스
#define		SEQ_STOP			0 MTI_STAND
#define		SEQ_WALK			1 MTI_WALK
#define		SEQ_ASTOP			2 MTI_STANDFIGHT
#define		SEQ_AWALK			3 MTI_WALKFIGHT
#define		SEQ_RUN				4
#define		SEQ_DEFENSE			6	
#define		SEQ_DAMAGE			7
#define		SEQ_DIE				8
#define		SEQ_BACKWARD		9
#define		SEQ_JUMP			10
#define		SEQ_FJUMP			11
#define		SEQ_JUMPREADY		12
#define		SEQ_LAND			13

#define		SEQ_ATTACK1 		20
#define		SEQ_ATTACK2			21

#define		SEQ_FSTAND			32
#define		SEQ_FRTURN			34
#define		SEQ_FLTURN			35

#define     SEQ_WALK_BACK_FIGHT  3 
#define     SEQ_WALK_BACK        9
*/
...
/*
// 오브젝트와 반응 동작 및 Lv1 기본 제스춰 
#define 해 가리기
#define 태양 오려다 보기
#define 외치기 (챗에서 외치기 동작)
#define 부정할때 고개 젖기
#define 긍정할 때 끄덕이기
#define 어깨 으쓱하기
#define 머리 긁적이기
...
#define 90도 
#define 큰절
#define 여자는 드레스를 가벼게 들고, 남자는 모자를 벗으며 인사
#define 손 흔들기 
#define 

// 곡예 
#define 덤블링
#define 공중에서 한바퀴 돌고 착지하기
#define 앞으로 점프해서 앞으로 구르기
#define 
// 운동 
// 격투 
// 감정표현
...
#define 가슴을 감싸기 (사랑표현 )
#define 손바닥에 입맞춤하고 날리는 표현
#define 환호하기
#define 생각하기
#define 손가락 꺽기
#define 손을 저어서 저리 치워하는 동작
#define 머리를 쥐고 절망하기
#define 귀를 양손으로 막고 고개를 젖기
#define 기뻐서 점프하기
#define 만세
#define 손으로 입 가리기 (어머!)
#define 웃기
...
//도발 
#define 주먹을 쥐어서 위협
#define 상대에게 스트레이트를 뻗기
#define 권투 자세, 스트레이트, 훅 
#define 따귀 때리기
#define 키스마이애스
#define 퍽큐
#define 컴온
#define 발을 들어 올렸다 내리기
#define 
...
/*
#define MTI_DRAWSWORDONE       40  // 칼 뽑기 
#define MTI_DRAWSWORDTWO       41  // 칼 뽑기 
#define MTI_DRAWAXEONE         42  // 도끼 뽑기 
#define MTI_DRAWAXETWO         43  // 도끼 뽑기 
#define MTI_DRAWSPEARONE       44  // 창 뽀기 
#define MTI_DRAWSPEARTWO       45  // 창 뽀기 
#define MTI_DRAWGUNONE         46  // 총 뽑기 
#define MTI_DRAWGUNTWO         47  // 총 뽑기 
#define MTI_DRAWRIFLEONE       48  // 라이플 뽑기 
#define MTI_DRAWRIFLETWO       49  // 라이플 뽑기 
#define MTI_DRAWWHIPONE        50  // 라이플 뽑기 
#define MTI_DRAWWHIPTWO        51  // 라이플 뽑기 
#define MTI_DRAWSTAFFONE       52  // 라이플 뽑기 
#define MTI_DRAWSTAFFTWO       53  // 라이플 뽑기 
#define MTI_DRAWCROSSBOW       52  // 라이플 뽑기 
#define MTI_DRAWBOW            52  // 라이플 뽑기 


// 전투 
#define MTI_ATK_SWD_ONE_HOR    100  //  
#define MTI_ATK_SWD_ONE_VER    101  //  
#define MTI_ATK_SWD_ONE_DIA    102  //  
#define MTI_ATK_SWD_ONE_THR    103  //  
#define MTI_ATK_SWD_TWO_HOR    104  //  
#define MTI_ATK_SWD_TWO_VER    105  //  
#define MTI_ATK_SWD_TWO_DIA    106  //  
#define MTI_ATK_SWD_TWO_THR    107  //  
#define MTI_ATK_SWD_DUA_HOR    108  //  
#define MTI_ATK_SWD_DUA_VER    109  //  
#define MTI_ATK_SWD_DUA_DIA    110  //  
#define MTI_ATK_SWD_DUA_THR    111  //  
#define MTI_ATK_AXE_ONE_HOR    112  //  
#define MTI_ATK_AXE_ONE_VER    113  //  
#define MTI_ATK_AXE_ONE_DIA    114  //  
#define MTI_ATK_AXE_ONE_THR    115  //    
#define MTI_ATK_AXE_ONE_HOR    116  //  
#define MTI_ATK_AXE_ONE_VER    117  //  
#define MTI_ATK_AXE_ONE_DIA    118  //  
#define MTI_ATK_AXE_ONE_THR    119  //  
#define MTI_ATK_AXE_ONE_HOR    120  //  
#define MTI_ATK_AXE_ONE_VER    121  //  
#define MTI_ATK_AXE_ONE_DIA    122  //  
#define MTI_ATK_AXE_ONE_THR    123  //  
#define MTI_ATK_AXE_TWO_HOR    124  //  
#define MTI_ATK_AXE_TWO_VER    125  //  
#define MTI_ATK_AXE_TWO_DIA    126  //  
#define MTI_ATK_AXE_TWO_THR    127  //  
#define MTI_ATK_AXE_TWO_HOR    128  //  
#define MTI_ATK_AXE_TWO_VER    129  //  
#define MTI_ATK_AXE_TWO_DIA    130  //    
#define MTI_ATK_AXE_TWO_THR    131  //  
#define MTI_ATK_TOOL_ONE_HOR   132  //  
#define MTI_ATK_TOOL_ONE_VER   133  //  
#define MTI_ATK_TOOL_ONE_DIA   134  //  
#define MTI_ATK_TOOL_ONE_THR   135  //  
#define MTI_ATK_SPEAR_TWO_HOR  136  //  
#define MTI_ATK_SPEAR_TWO_VER  137  //  
#define MTI_ATK_SPEAR_TWO_DIA  138  //  
#define MTI_ATK_SPEAR_TWO_THR  139  //  
#define MTI_ATK_STAFF_TWO_HOR  140  //  
#define MTI_ATK_STAFF_TWO_VER  141  //  
#define MTI_ATK_STAFF_TWO_DIA  142  //  
#define MTI_ATK_STAFF_TWO_THR  143  //  
#define MTI_ATK_WHIP_TWO_HOR   144  //  
#define MTI_ATK_WHIP_TWO_VER   145  //    
#define MTI_ATK_WHIP_TWO_DIA   146  //  
#define MTI_ATK_WHIP_TWO_THR   147  //  
#define MTI_ATK_THROWGRE       148  //  
#define MTI_ATK_THROWDART      149  //    
#define MTI_ATK_BOW            150  //  
#define MTI_ATK_CROSSBOW       151  //  
#define MTI_ATK_GUNONEPIS      152  //  
#define MTI_ATK_GUNDUALPIS     153  //  
#define MTI_ATK_GUNRIFLE       154  //  
#define MTI_ATK_GUNMACIN       155  //  
#define MTI_ATK_GUNLAUN        156  //  
  */
