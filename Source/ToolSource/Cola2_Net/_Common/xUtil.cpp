...
//////////////////////////////////////////////////////////////////////////
// 소문자로 변환한후 lval에 rval가 포함되어 있는지 판단 
BOOL strstrlwr( const TCHAR* lval, const TCHAR* rval )
{
	static TCHAR lbuffer[ 256 ];
	static TCHAR rbuffer[ 256 ];

	strcpy( lbuffer, lval );
	strcpy( rbuffer, rval );

	if( strstr( _strlwr( lbuffer ), _strlwr( rbuffer ) ) )
		return TRUE;
