	...
	if( b )
	{
		...
		case 4:
			...
			case 0:		
				...
				break;
			case 10:	strcat( _szTempBuff, "Windows 98 " );	break;
			case 90:	strcat( _szTempBuff, "Windows Me " );	break;
			}
			break;
		case 5:
			switch( versionInformation.dwMinorVersion )
			{
			case 0:		strcat( _szTempBuff, "Windows 2000 " );	break;
			case 1:		strcat( _szTempBuff, "Windows XP " );	break;
			case 2:		strcat( _szTempBuff, "Windows Server 2003 family " );	break;
