...
#define AUTH_GAMEMASTER    'L' // 게임 마스터 ; 게임 전체의 진행이 가능한 계정 
#define AUTH_OPERATOR      'O' // 더미 계정 ; 현재는 AUTH_ADMINISTRATOR과 같은 기능으로 세팅 
#define AUTH_ADMINISTRATOR 'P' // 관리자 계정 ; 모든 기능을 사용할 수 있음.
...
#define ATTACK_MODE			(DWORD)0x00000040	// 공격 못하는 상태
