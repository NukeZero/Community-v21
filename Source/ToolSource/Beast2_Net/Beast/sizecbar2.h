...
// CSizingControlBar2 and put there what you need.
...
#include "CoolDialogBar.h"   // for CArray
...
{
    friend class CSizingControlBar2;
};

/////////////////////////////////////////////////////////////////////////
// CSizingControlBar2 control bar styles
...
/////////////////////////////////////////////////////////////////////////
// CSizingControlBar2 control bar

#ifndef baseCSizingControlBar2
#define baseCSizingControlBar2 CControlBar
#endif

class CSizingControlBar2;
typedef CTypedPtrArray <CPtrArray, CSizingControlBar2*> CSCBArray;

class CSizingControlBar2 : public baseCSizingControlBar2
{
    DECLARE_DYNAMIC(CSizingControlBar2);
...
public:
    ...
    //{{AFX_VIRTUAL(CSizingControlBar2)
    public:
...
class CSizingTabCtrlBar2 : public CCoolDialogBar //public CSizingControlBar2
{
// Konstruktion
public:
	CSizingTabCtrlBar2();
    virtual void OnUpdateCmdUI(CFrameWnd* pTarget, BOOL bDisableIfNoHndler);
	virtual void ResizeControls( CRect& rect );
...
// ?erschreibungen
	...
	//{{AFX_VIRTUAL(CSizingTabCtrlBar2)
	//}}AFX_VIRTUAL
...
public:
	...
	CTabCtrl m_tabctrl;
	virtual ~CSizingTabCtrlBar2();

	// Generierte Nachrichtenzuordnungsfunktionen
protected:
	int m_nActiveTab;
	CView* m_pActiveView;
	CList <TCB_ITEM2 *,TCB_ITEM2 *> m_views;
	CImageList m_images;
	//{{AFX_MSG(CSizingTabCtrlBar2)
	afx_msg int OnCreate(LPCREATESTRUCT lpCreateStruct);
