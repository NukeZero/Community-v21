...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifdef __WORLDSERVER
MemPooler<CAIGuard>*	CAIGuard::m_pPool		= new MemPooler<CAIGuard>( 256 );
#else	// __WORLDSERVER
 #ifndef __ONLINE
 MemPooler<CAIGuard>*	CAIGuard::m_pPool		= new MemPooler<CAIGuard>( 128 );
 #else	// not Online(Single)
 MemPooler<CAIGuard>*	CAIGuard::m_pPool		= NULL; //new MemPooler<CAIGuard>( 128 );
 #endif // onLine
#endif	// __WORLDSERVER

static int s_tmAttack = SEC(10);		//  m_timerAttack, 한국은 5초 일본은 10초
