...
#if _MSC_VER > 1700
D3DXINLINE float D3DXVec3Length(D3DXVECTOR3 && pV)
{
	return sqrtf(pV.x * pV.x + pV.y * pV.y + pV.z * pV.z);
}
#endif
...
D3DXINLINE float D3DXVec3LengthSq(D3DXVECTOR3 &&pV)
{
	return pV.x * pV.x + pV.y * pV.y + pV.z * pV.z;
}
...
D3DXINLINE void D3DXVec3Cross(D3DXVECTOR3& pOut, D3DXVECTOR3 &&pV1, D3DXVECTOR3 &&pV2)
{
	D3DXVECTOR3 v;
#ifdef D3DX_DEBUG
	if (!pV1 || !pV2) return;
